...
def upload_strength_workout(
    ...
    Args:
        ...
        replace_existing: If true, replace existing workouts with the same name after successful upload.
    ...
    return upload_strength_workout_payload(
        payload,
        replace_existing=replace_existing,
        name_match_mode=name_match_mode,
        connectapi_fn=garth.connectapi,
        format_error=_format_garth_error,
        logger=logger,
    )
